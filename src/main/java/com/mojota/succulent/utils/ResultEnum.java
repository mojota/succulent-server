...
public enum ResultEnum {
    ...
    BUSINESS_ERROR_USER_NOT_EXIST(2011, GlobalConstants.MSG_BUSINESS_ERROR_USER_NOT_EXIST),
    BUSINESS_ERROR_SEND_CODE(2012, GlobalConstants.MSG_BUSINESS_ERROR_SEND_CODE),
    BUSINESS_ERROR_CODE_INCORRECT(2013, GlobalConstants.MSG_BUSINESS_ERROR_CODE_INCORRECT),
    BUSINESS_CONTENT_TOO_LONG(2014, GlobalConstants.MSG_BUSINESS_CONTENT_TOO_LONG),
    BUSINESS_NOTE_TITLE_EMPTY(2015, GlobalConstants.MSG_BUSINESS_NOTE_TITLE_EMPTY),
    BUSINESS_ERROR_SENSITIVE_WORDS(2016,GlobalConstants.MSG_BUSINESS_ERROR_SENSITIVE_WORDS);
